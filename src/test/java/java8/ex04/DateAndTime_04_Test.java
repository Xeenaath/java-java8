...
public class DateAndTime_04_Test {
    ...
    public void test_localDateTime_parse() {
        ...
        LocalDateTime result = LocalDateTime.parse("2009-03-02 09:30:00", formatter);
    ...
    public void test_localDateTime_format() {
        ...
        LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(2017, 11, 27), LocalTime.of(12, 00));
